# baseline/claa/monkeypatch.py
from importlib.metadata import version
import warnings
import transformers

from transformers.models.llama.modeling_llama import LLAMA_ATTENTION_CLASSES
from baseline.claa.llama_hijack_4_45 import (
    LlamaCLAAAttention,
...
from baseline.claa.mistral_hijack_4_45 import (
    MistralCLAAAttention,
...
def replace_llama():
    ...
    if warning_flag:
        warnings.warn(
            f"Transformers version {transformers_version} might not be compatible with CLAA. CLAA is tested with Transformers version {version_list}.")
    
    LLAMA_ATTENTION_CLASSES['flash_attention_2'] = LlamaCLAAAttention
...
def replace_mistral():
    ...
    MISTRAL_ATTENTION_CLASSES['flash_attention_2'] = MistralCLAAAttention
