...
from baseline.claa.claa_utils import init_claa
...
class LlamaCLAAAttention(LlamaFlashAttention2):
...
def llama_decoderlayer_forward(
        ...
        **kwargs,
        ...
        # [CLAA] get average token indices
        # Self Attention
        ...
        # [CLAA] Select important tokens and adjust position_ids at TSP layer
...
def llama_model_forward(
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # [CLAA] get new position ids from decoder layer
        ...
        # [CLAA] Cut-off hidden states like AdaKV
