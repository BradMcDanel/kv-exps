        ...
        if past_key_value is not None:
            ...
            if q_len > 1:
                key_states_compress, value_states_compress, self.tsp_idx = self.kv_cluster.update_kv(
                    key_states, query_states, value_states, attention_mask, self.num_key_value_groups, self.layer_idx, **kwargs)
...
def llama_model_forward(
        ...
        # This is the shared state for TAPER's cumulative scoring
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                # Gradient checkpointing does not support passing extra kwargs.
                # The custom TAPER logic is for inference, so this path is less critical.
