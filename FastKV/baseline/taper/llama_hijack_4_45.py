# baseline/taper/llama_hijack_4_45.py
import torch
...
from baseline.taper.taper_utils import init_taper

logger = logging.get_logger(__name__)

class LlamaTaperAttention(LlamaFlashAttention2):
...
def llama_model_forward(
    ...
    for i, decoder_layer in enumerate(self.layers):
        ...
        if new_position_ids is not None:
            ...
            # Recompute position embeddings for the new, shorter sequence
            position_embeddings = self.rotary_emb(hidden_states, position_ids)
