# baseline/taper/monkeypatch.py
from importlib.metadata import version
import warnings
import transformers

from transformers.models.llama.modeling_llama import LLAMA_ATTENTION_CLASSES
from baseline.taper.llama_hijack_4_45 import (
    LlamaTaperAttention,
...
from baseline.taper.mistral_hijack_4_45 import (
    MistralTaperAttention,
...
def replace_llama():
    ...
    if warning_flag:
        warnings.warn(
            f"Transformers version {transformers_version} might not be compatible with Taper. Taper is tested with Transformers version {version_list}.")
    
    LLAMA_ATTENTION_CLASSES['flash_attention_2'] = LlamaTaperAttention
...
def replace_mistral():
    ...
    MISTRAL_ATTENTION_CLASSES['flash_attention_2'] = MistralTaperAttention
