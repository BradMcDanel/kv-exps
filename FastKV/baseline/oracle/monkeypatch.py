...
from baseline.oracle.llama_hijack_4_45 import (
    LlamaOracleAttention,
    llama_decoderlayer_forward,
    llama_model_forward
)

from transformers.models.mistral.modeling_mistral import MISTRAL_ATTENTION_CLASSES
from baseline.oracle.mistral_hijack_4_45 import (
    MistralOracleAttention,
...
def replace_llama():
    ...
    LLAMA_ATTENTION_CLASSES['flash_attention_2'] = LlamaOracleAttention
...
def replace_mistral():
    ...
    MISTRAL_ATTENTION_CLASSES['flash_attention_2'] = MistralOracleAttention
