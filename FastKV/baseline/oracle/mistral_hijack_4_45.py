...
from baseline.oracle.oracle_utils import init_oracle
...
class MistralOracleAttention(MistralFlashAttention2):
...
def mistral_decoderlayer_forward(
        ...
        **kwargs,
        ...
        # [Oracle] get average token indices
        # Self Attention
        ...
        # [Oracle] Select important tokens and adjust position_ids at TSP layer
...
def mistral_model_forward(
        ...
        for decoder_layer in self.layers:
            ...
            if self.gradient_checkpointing and self.training:
                ...
                # [Oracle] get new position ids from decoder layer
        ...
        # [Oracle] Cut-off hidden states like AdaKV
